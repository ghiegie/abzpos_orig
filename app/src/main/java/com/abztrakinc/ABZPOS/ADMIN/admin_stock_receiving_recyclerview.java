...
import java.util.List;
    ...
    public class admin_stock_receiving_recyclerview extends RecyclerView.Adapter<admin_stock_receiving_recyclerview.MyViewHolder>{


    private ArrayList<invoice_plu_model> ButtonList;
    private android.content.Context Context;
    ArrayList<String>Selectlist = new ArrayList<String>();
    private admin_stock_receiving_recyclerview.MyViewHolder holder;
...
//            Log.d("SELECTED ID",headerFooterID.get(position).toString());
        ...
        public admin_stock_receiving_recyclerview(Context context, ArrayList<invoice_plu_model> buttonList,OnClickListener onClickListener) {
    ...
    @NonNull
    @Override
    public admin_stock_receiving_recyclerview.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        admin_stock_receiving_recyclerview.MyViewHolder holder = new admin_stock_receiving_recyclerview.MyViewHolder(view);
        return holder;
    }
    @Override
    public void onBindViewHolder(@NonNull admin_stock_receiving_recyclerview.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        this.holder = holder;
