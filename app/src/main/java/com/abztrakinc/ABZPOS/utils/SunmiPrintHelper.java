package com.abztrakinc.ABZPOS.utils;
...
public class SunmiPrintHelper {
    ...
    public void printText(String content, float size, boolean isBold, boolean isUnderLine,
        ...
        try {
            ...
            Log.e("printext",content);
        } catch (RemoteException e) {
            e.printStackTrace();
            Log.e("printext","error");
        }
    ...
    public void printExample(Context context){
        ...
        try {
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.c);
            sunmiPrinterService.printBitmap(bitmap, null);
