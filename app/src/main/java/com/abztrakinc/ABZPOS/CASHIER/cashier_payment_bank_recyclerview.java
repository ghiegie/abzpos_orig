...
import com.abztrakinc.ABZPOS.ADMIN.admin_stock_receiving_recyclerview;
...
public class cashier_payment_bank_recyclerview extends RecyclerView.Adapter<cashier_payment_bank_recyclerview.MyViewHolder> {

    private ArrayList<invoice_plu_model> ButtonList;
    private android.content.Context Context;
    ArrayList<String> Selectlist = new ArrayList<String>();
    private cashier_payment_bank_recyclerview.MyViewHolder holder;
    private cashier_payment_bank_recyclerview.OnClickListener onClickListener;
...
//            Log.d("SELECTED ID",headerFooterID.get(position).toString());
    ...
    public cashier_payment_bank_recyclerview(android.content.Context context, ArrayList<invoice_plu_model> buttonList, cashier_payment_bank_recyclerview.OnClickListener onClickListener) {
    ...
    @NonNull
    @Override
    public cashier_payment_bank_recyclerview.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        cashier_payment_bank_recyclerview.MyViewHolder holder = new cashier_payment_bank_recyclerview.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull cashier_payment_bank_recyclerview.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        this.holder = holder;
